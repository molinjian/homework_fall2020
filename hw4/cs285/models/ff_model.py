...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        delta_pred_normalized = self.delta_network(concatenated_input).squeeze(1)
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        prediction = self.forward(obs, acs, obs_mean, obs_std, acs_mean,acs_std, delta_mean, delta_std)[0]
        prediction = ptu.to_numpy(prediction.detach())
